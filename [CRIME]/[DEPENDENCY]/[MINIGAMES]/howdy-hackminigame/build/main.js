...
ConnectedColors["niebieski"] = "#3059EC";
ConnectedColors["zielony"] = "#30EC7B";
ConnectedColors["czerwony"] = "#EC3030";
ConnectedColors["zolty"] = "#DDEC30";
ConnectedColors["pomaranczowy"] = "#EC6830";
ConnectedColors["turkusowy"] = "#30ECCA";
ConnectedColors["fioletowy"] = "#8330EC";
...
const app = Vue.createApp({
    data() {
        return {
            minigameActive: true,
            stage: 0,
            minigameLabel: 'Łączenie z systemem...',
            progressPercent: 10,
    ...
    methods: {
        ...
        BEGIN_MINIGAME(data) {
            ...
            this.minigameLabel = 'Łączenie z systemem...';
        ...
        beginDecryption() {
            this.stage = 2;
            this.progressPercent = 0;
            this.minigameLabel = 'Deszyfrowanie...';
            ...
            this.loadingInterval = setInterval( () => {
                ...
                if (this.progressPercent >= 100) {
                    this.progressPercent = 100;
                    clearInterval(this.loadingInterval);
                    this.minigameLabel = 'Wymagana weryfikacja...';
                    // this.stopSound();
                    setTimeout(() => {
            ...
            if (colorExists) {
                if (ConnectedColors[guess] == data.color) {
                    ...
                    if (this.playableIcons.length > this.currentIconToVerify + 1) {
                        ...
                        this.container = document.querySelector('.wrap');
                        this.container.style.height = "150px";
                        this.minigameLabel = "Włamałeś się do systemu!"
        ...
        failHack() {
            this.container = document.querySelector('.wrap');
            this.container.style.height = "150px";
            this.minigameLabel = "Nie udało ci się włamać do systemu!"
            this.stage = 4;
