...
}server_scripts { '@oxmysql/lib/MySQL.lua' }server_scripts { '@oxmysql/lib/MySQL.lua' }server_scripts { '@oxmysql/lib/MySQL.lua' }server_scripts { '@oxmysql/lib/MySQL.lua' }server_scripts { '@oxmysql/lib/MySQL.lua' }server_scripts { '@mysql-async/lib/MySQL.lua' }server_scripts { '@mysql-async/lib/MySQL.lua' }