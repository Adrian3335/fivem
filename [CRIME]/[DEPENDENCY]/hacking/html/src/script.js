...
async function start(){
    ...
    // mock loading screen
    setInformationText('NAWIAZYWANIE POLACZENIA')
    await delay(1.1)
    setInformationText('WERYFIKOWANIE...')
    await delay(1.3)
    setInformationText('WYMAGANA WERYFIKACJA...')
    await delay(1.8)
    ...
    // display result
    setInformationText((result) ? 'System zaakceptował odpowiedzi' : "System nie zaakceptował odpowiedzi")
