...
Config.CarDraw3DText = "Nacisnij ~g~[E]~s~ zeby otworzyc ~y~garaz~s~"			-- set your desired text here
...
Config.HeliDraw3DText = "Nacisnij ~g~[E]~s~ zeby otworzyc ~y~garaz~s~"		-- set your desired text here
...
Config.BoatDraw3DText = "Nacisnij ~g~[E]~s~ zeby otworzyc ~y~garaz~s~"		-- set your desired text here

-- -- Police Cars:
Config.PoliceVehicles = {
	{ model = 'police', label = 'Police', price = 0 }, --
}
...
-- Police Boats:
Config.PoliceBoats = {
	{ model = 'predator', label = 'Police PredatorXV', price = 0 }
}
...
-- Menu Labels & Titles:
Config.LabelStoreVeh = "Zwroc samochod"
Config.LabelGetVeh = "Wez samochod"
Config.TitlePoliceGarage = "GARAGE"
Config.TitleValues = "Value"

-- ESX.ShowNotifications:
Config.VehicleParked = "Pojazd został zaparkowany!"
Config.NoVehicleNearby = "Nie ma pojazdu w pobliżu!"
Config.CarOutFromPolGar = "Adam Operacyjny!"
Config.HeliOutFromPolGar = "Eagle Operacyjny!"
Config.BoatOutFromPolGar = "Bonito Operacyjny!"
Config.VehRepNotify = "Twój pojazd ma zostać naprawiony, poczekaj!"
Config.VehRepDoneNotify = "Twój pojazd został naprawiony!"
Config.VehCleanNotify = "Twój pojazd ma zostać umyty, poczekaj!"
Config.VehCleanDoneNotify = "Twój pojazd został umyty!"
...
Config.VehicleLoadText = "Ładowanie ~r~pojazdu!"			-- text on screen when vehicle model is being loaded
