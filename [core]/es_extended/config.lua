...
Config.StartingAccountMoney = { bank = 5000000 }

Config.StartingInventoryItems = true -- table/false

Config.DefaultSpawns = { -- If you want to have more spawn positions and select them randomly uncomment commented code or add more locations
    { x = -260.24, y = -974.56, z = 31.24, heading = 1.0 }
}
...
Config.MaxWeight = 60 -- the max inventory weight without a backpack
